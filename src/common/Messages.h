...
enum LookupInstructionType : unsigned char {
  ...
  GETDSBLOCKFROML2LDATAPROVIDER = 0x021,
  GETVCFINALBLOCKFROML2LDATAPROVIDER = 0x022,
  GETMBNFWDTXNFROML2LDATAPROVIDER = 0x023,
  GETPENDINGTXNFROML2LDATAPROVIDER = 0x024,
  GETMICROBLOCKFROML2LDATAPROVIDER = 0x25,
  GETTXNFROML2LDATAPROVIDER = 0x26
};
